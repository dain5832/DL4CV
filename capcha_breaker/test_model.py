...
from DL4CV_PractitionerBundle.pyimagesearch.utils import preprocess
...
for imagePath in imagePaths:
    ...
    # to ensure digits caught near the border of the image are retained
    ...
    thresh = cv2.threshold(gray, 0, 255,\
        cv2.THRESH_BINARY_INV | cv2.THERSH_OTSU)[1]
    ...
    # initilize the output image as a "grayscale"
