...
# generate a 2-class classification probelm with 1,000 data points,
...
# initialize our wright matrix and list of losses
print("[INFO] training...")
...
for epoch in np.arange(0, args["epochs"]):
    ...
    # update our loss history by taking the avaerage loss across all
    # batches
